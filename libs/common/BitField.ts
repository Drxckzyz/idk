export const BitfieldRangeError = new RangeError('Failed to resolve bits; expected a bigint, string, a Bitfield, or an array of any of the previous');
